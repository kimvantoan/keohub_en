...
<div class="flex h-full w-full">
                ...
                <li>
                    <a href="#" class="flex items-center gap-3 hover:text-primary transition-colors group">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path border="round" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z"></path>
                        </svg>
                        Premier League
                    </a>
                </li>
    ...
    <div class="flex-grow overflow-y-auto bg-white p-4 md:p-8 lg:py-12 lg:px-8 relative w-full">
        <div class="max-w-[1100px] mx-auto flex flex-col gap-8 md:gap-10">
            ...
            <div class="block lg:hidden w-full overflow-x-auto pb-2 -mt-2 -mb-2" style="scrollbar-width: none; -ms-overflow-style: none;">
                ...
                <style>
                    .block.lg\\:hidden::-webkit-scrollbar {
                        display: none;
                    }
                </style>
